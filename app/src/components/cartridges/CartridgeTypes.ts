...
export interface CartridgeRecord {
  ...
  /** username that installed or trained this cartridge — null if unowned */
...
/** Response shape from GET /api/cartridges/:persona/active */
...
export const PERSONA_LABELS: Record<CartridgePersona, string> = {
  sayon: 'SAYON',
  seren: 'SEREN',
  both:  'Both',
};