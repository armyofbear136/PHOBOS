...
try:
    ...
    # AMD Windows ROCm: _c10d_functional ops not registered — only used for multi-GPU all_gather
    NF4_OPS_TABLE: Dict[Any, Any] = {}
...
try:
    ...
    pass  # AMD Windows ROCm: _c10d_functional.wait_tensor not registered
...
if torch_version_at_least("2.11.0.dev"):
    try:
        ...
        pass  # AMD Windows ROCm: _c10d_functional._wrap_tensor_autograd not registered
