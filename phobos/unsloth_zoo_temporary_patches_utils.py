...
try:
    ...
    elif "_distributed_c10d" in e or ("torch._C" in e and "not a package" in e):
        Unpack = t_Unpack  # AMD Windows ROCm: import failed but Unpack is needed below — alias t_Unpack
